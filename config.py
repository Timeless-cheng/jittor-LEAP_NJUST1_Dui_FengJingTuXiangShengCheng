...
def add_all_arguments(parser, train):
    ...
    parser.add_argument('--root', type=str, default='../datasets', help="root of the datasets")
    ...
    parser.add_argument('--no_EMA', default=True, help='if specified, do *not* compute exponential moving averages')
    ...
    if train:
        ...
        parser.add_argument('--freq_save_latest', type=int, default=5, help='frequency of saving the latest model')
        ...
        parser.add_argument('--freq_fid', type=int, default=5, help='frequency of saving the fid score (in training iterations)')
        ...
        parser.add_argument('--lr_g', type=float, default=0.0004, help='G learning rate, default=0.0001')
    ...
    parser.add_argument('--output_path', type=str, default='./results/', help='saves testing results here.')
